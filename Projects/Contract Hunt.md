...
- **Availability / notice wording (Rob, 2026-08-24):** cover notes and calls frame timing as a **mutually agreed exit** from the most recent engagement: "I can start within X weeks; the exit from my current engagement is mutually agreed, so there is no drama on timing." Never "notice period", never "they are cost saving", never anything that implies employment or that the employer wants rid.
