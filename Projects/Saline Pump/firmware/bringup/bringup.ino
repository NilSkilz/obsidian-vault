...
//
// Flash this over USB with the devkit BARE ON THE DESK, before it ever
// goes in the board socket. GPIO14 (Pump L gate) emits a PWM burst during
// boot; the 10k pulldown tames it and this sketch pins it off immediately
// after. GPIO13 (Pump R) is boot-clean but gets the same treatment.
//
...
void loop() {
  // Heartbeat: short blink every second, serial ping every 5s.
