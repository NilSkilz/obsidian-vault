...
### Schematic drawn (2026-08-14)

First importable schematic done: `Projects/Saline Pump/pcb/saline_pump.kicad_sch` (KiCad 7/8), generated by `pcb/gen_schematic.py` (regenerate by editing the Python, not the .kicad_sch). Self-contained (all symbols defined locally, wiring by net-label), 26 parts, 27 nets, validated: no floating nets, no accidental shorts. Import steps + full pin table in `pcb/README.md`.
