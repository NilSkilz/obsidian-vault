...
- **Caveat:** both disks are in the *same host* — this protects against disk failure / fat-fingered deletes, NOT against the box dying, theft, or fire. Real DR = the offsite/PBS proposal in `Ops/Proposals.md`, still open.
