...
- **Still needed from Rob:** exact inverter model number (side label — gives AC rating), array kWp (MCS cert), current tariff + whether SEG is actually registered, consumer unit photo + space near the inverter. Then sizing/payback maths.
