...
- **Still needed from Rob:** array kWp (MCS cert), current tariff + whether SEG is actually registered, consumer unit photo + space near the inverter. Then sizing/payback maths. (Inverter model captured 17 Sep: S6-GR1P3.6K.)
