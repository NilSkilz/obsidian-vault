...
- **Pension:** Superdry workplace scheme is with **Standard Life**, plan number D4431472000 (confirmed 25 Sep 2026 from Standard Life enrolment emails, Aug-Oct 2024). Payslip line "SS Pension" = salary sacrifice: Rob £300.42/month (5%) + employer £240.33 (4%) = £540.75 total (9% of full salary). Gross £6,008.33/month pre-sacrifice = £72,100/yr; percentages apply to full salary, not just qualifying earnings, so this beats the auto-enrolment floor (8% total on the £6,240-£50,270 band). Net cost of Rob's 5% is only ~£173/month after 40% tax + 2% NI relief. Rob registered for the online account 25 Sep 2026: value **£37,376**. Separate from his personal PensionBee pot (old pensions consolidated there Dec 2024), **£20,583.37** at 25 Sep 2026. Both tracked on Tide /finances as "Rob's pensions" (£57,959.37 combined).
