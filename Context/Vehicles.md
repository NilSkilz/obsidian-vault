...
The household's two cars, with MOT/tax renewal dates. Checked 2026-08-22 against DVLA data via two independent online checkers (gov.uk blocks bots directly). MOT/tax expiry events are on the **Shared Home Calendar**, and each has a Todoist "book the MOT" task set ~2 weeks before.

## Car 1 — Ford Fiesta (Rob's)
- **Reg: CV59 POA**
- Blue 2009 Ford Fiesta Zetec
- **MOT expires: 25 Sep 2027** (PASSED, Rob confirmed 23 Sep 2026; test was booked for Mon 22 Sep, done within the month before old expiry so the anniversary date carries over)
