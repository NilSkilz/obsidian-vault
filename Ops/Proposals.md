...
**Problem:** `ha addons update --backup core_ssh` has now failed five heartbeat runs (2026-08-20, 2026-08-21, 2026-08-23, 2026-08-24, 2026-08-25), stuck at 10.3.0 while 10.4.0 is available. HA core/OS and everything else update clean (host + all 18 LXCs upgraded fine again on 2026-08-25). HA itself is fully up. Already flagged to Rob via Telegram on 2026-08-20, so not re-pinging for the same unresolved issue, but this is now five-for-five, not a blip.
