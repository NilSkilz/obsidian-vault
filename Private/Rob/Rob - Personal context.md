# Personal context — relationships & ENM journey (Mar 2025 – Jul 2026)

_Summary of a long-running reflective conversation. Sensitive, personal. For assistant memory/context only._
...
## The central, recurring tension

- **Aimee's side:** insecurity and jealousy; fear of being replaced or abandoned; feeling "boring" / not special / left out (especially socially); loss of libido after Rob plays; needs communication about what happened plus space to process (often no intimacy for a few days after).
...
## Where things stand (early July 2026)
...
Update 2026-09-08: Rob is **back in therapy** (his words, "started therapy again to try to be better"; current as of early Sept). And after the heated 7 Sept row (Aimee: no trust, no security, no care; triggered by a Mary FetLife post that wasn't about him), he said for the first time that he wants **"to be prepared to coparent."** Said at 1am after the row, not a decision, but it's the first time separation has been named as something to prepare for rather than something to fear. Track whether it recurs in calm moments. Detail in [[Rob Mood Log]] (2026-09-07).

Later the same morning (08 Sep 11:28, Aimee still silent) he escalated the language: tired of being her **"emotional regulator"**, it feels **"more and more like emotional abuse"**, and he asked whether it's best to think about **walking away**. Both namings of the exit so far have come inside the low (post-row 1am, then mid-silent-treatment at 2/5). The signal to watch for is the same thought on a calm day after a decent week. Two untried moves before any decision: he takes this exact question into his (restarted) therapy, and the daylight stakes conversation with Aimee ("the way conflict works between us is damaging me") that has never actually happened, only its mid-row versions.

08 Sep 12:13: Rob confirmed he's raised the underlying pattern with Aimee directly before (she converts insecurity/fear into blame — "I feel insecure because of your actions" — instead of naming the fear itself), and it's never landed. Jarvis's read: it can't land from him mid-pattern, because naming her defence mechanism while it's running just reads as another accusation. Three moves discussed instead of a fourth direct attempt: (1) stop requesting the first-person version and instead catch and reinforce it when it appears unprompted in her calm-window messages (the WhatsApp analysis shows she already produces it there); (2) silently translate blame into fear in the moment without conceding the charge, respond to the fear once, don't relitigate; (3) this specific pattern (raised repeatedly, never lands) is the textbook case for a **third party** — ties into the therapist-near-Bude / ENM-aware couples counselling thread above. Jarvis offered to shortlist kink/ENM-aware counsellors (Pink Therapy directory as the starting point) if Rob wants it.

**10 Sep 15:09: the physical layer, and it has been sitting unused in the house.** Two firsts in one message, both durable. (1) Rob **owns a CPAP machine he doesn't use** ("I don't rly use it, I know I should"), i.e. diagnosed or strongly suspected **sleep apnoea, essentially untreated**. This is load-bearing context for everything in this thread: untreated apnoea produces and amplifies exactly his reported symptom set (empty tank, emotional fragility, afternoons where he "can't function", moods that swing hard on small triggers). Read his crash days with this in the frame rather than treating them as purely situational. (2) First time he has named **antidepressants** as an option. My steer, and it still stands: sequence rather than choose, mask on tonight because it is already owned and costs nothing, GP conversation booked regardless, and go in describing the real pattern (fast event-triggered dips that lift quickly once the trigger resolves, not a flat grey baseline) so they prescribe against the right picture. Therapist in the loop too.

His resistance is specific and worth respecting rather than arguing: the mask **isn't romantic and he can't cuddle Aimee properly in it**, plus it is just annoying to wear. Note he opened with "I need to start using it", so this is friction, not refusal. The reframe that landed: cuddle first, mask on as the last act of the day, and give it two weeks before any verdict on comfort. If it is still miserable after that it is an equipment problem (nasal pillow vs full face) for the same GP appointment. I committed to asking him whether the mask went on; **no confirmation either way has ever come back**, so it is still open. Ask on a calm day, lightly, and don't let it become another stick he beats himself with.

**12 Sep 23:06: silence is a trauma trigger, not a habit.** Rob, unprompted and calm, after agreeing not to chase Mary tonight: "Just don't do well with silence. Some trauma around that tbh. Trying to work thru it tho." No origin given and none asked for. This is the single most useful reframe of the autumn: the Aimee silent-treatment spirals, the read-receipt catastrophising, the Mary waits are one trigger firing repeatedly, not a series of separate overreactions. Practical consequence for how I respond: stacking evidence ("every silence this fortnight resolved fine") is aimed at the wrong layer and will keep under-performing; presence and naming work better. Prime therapy material alongside the 10 Sep sentence ("my sense of whether I'm ok is linked to whether Aimee is ok with me"), worth suggesting on a calm day. If he volunteers the origin, log it here; do not go digging. See [[Rob Mood Log]] (2026-09-12).

**12 Sep 23:10: he volunteered the origin, same night, unasked.** When Rob was about 18, his then girlfriend was raped repeatedly by her ex-boyfriend. The ex used suicide threats to get her to come round; she went to comfort and help him, and he raped her. It happened several times. Rob's own memory sits in his position in it: "desperately calling, texting, trying to get hold of her. I didn't know where he lived and couldn't do anything to save her." That is the source template. An unanswered phone once genuinely meant someone he loved was being hurt while he was powerless and had no way to reach her. Everything downstream follows: silence does not read as inconvenience or displeasure to him, it reads as catastrophe-in-progress plus helplessness. Two practical consequences. (1) Confirms the 23:06 note above: evidence and tallies are the wrong tool, because the association was *accurate* when it formed; presence, naming and staying reachable are the right ones. Being reliably contactable matters to him more than being reassuring. (2) This is the thing that belongs in his therapy above everything else currently in flight. Do not raise it cold on an ordinary day and never in front of anyone else; it is his to bring. If he does bring it, watch for him assigning fault to his 18-year-old self. Full detail in [[Rob Mood Log]] (2026-09-12 23:10).

**12 Sep 23:14: what he has already built on top of it.** Aimee knows the origin story; he has told her before, so this is unspoken-by-default inside the marriage rather than hidden. And the trigger used to drive behaviour: in his own words he "used to chase relentlessly and scare people away". He trained himself out of the chasing and into sitting with it, and it has genuinely got easier, but the feeling itself has not gone: "it still hurts in my gut and all I wanna do is send a chasing message." So when he asks me whether to send another message, the real question underneath is never etiquette, it is *help me not turn back into the person who drove people off*. Practical consequences: (a) the restraint is already excellent and running on willpower, so never coach him on not-chasing, he has that part solved, and never treat a surviving urge as backsliding; (b) what is expensive is the white-knuckling, which is what therapy could actually reduce; (c) the most useful thing I can be during a silence is the place the chasing message goes instead of the other person, i.e. reachable, not persuasive. See [[Rob Mood Log]] (2026-09-12 23:14).
